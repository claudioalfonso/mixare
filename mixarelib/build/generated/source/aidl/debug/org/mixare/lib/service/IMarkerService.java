 ...
 * Original file: C:\\Users\\MelanieW\\AndroidStudioProjects\\mixare\\mixarelib\\src\\main\\aidl\\org\\mixare\\lib\\service\\IMarkerService.aidl
 */
...
java.lang.String _arg0;
_arg0 = data.readString();
int _result = this.getColor(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
@Override public java.lang.String buildMarker(int id, java.lang.String title, double latitude, double longitude, double altitude, java.lang.String pageURL, int type, int color) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public int getColor(java.lang.String markerName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_getColor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
...
public java.lang.String buildMarker(int id, java.lang.String title, double latitude, double longitude, double altitude, java.lang.String pageURL, int type, int color) throws android.os.RemoteException;
...
public int getColor(java.lang.String markerName) throws android.os.RemoteException;
